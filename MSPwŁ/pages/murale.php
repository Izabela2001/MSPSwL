    ...
    <ul class="eList">
        ...
        if (sqlsrv_has_rows($stmt)) {
            while ($row = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)) {
                ...
                echo "<p><strong>Historia:</strong> " . (!is_null($row['Historia']) ? htmlspecialchars($row['Historia']) : 'Brak danych') . "</p>";
                echo "<p><strong>Jak dotrzeć:</strong> " . (!is_null($row['Jak dotrzeć']) ? htmlspecialchars($row['Jak dotrzeć']) : 'Brak danych') . "</p>";
                ...
                echo "<p><strong>Imię autora:</strong> " . (!is_null($row['Imię autora']) ? htmlspecialchars($row['Imię autora']) : 'Brak danych') . "</p>";
                echo "<p><strong>Nazwisko autora:</strong> " . (!is_null($row['Nazwisko autora']) ? htmlspecialchars($row['Nazwisko autora']) : 'Brak danych') . "</p>";
