...
function getData($conn) {
    $obiekty = [];
    $sql = "SELECT * FROM uf_ObiektyMurale()";
...
if (isset($_POST['delete'])) {
    ...
    echo "<script>window.location.replace('ListaMurali.php');</script>";
    exit;
}
?>
...
<main class="ListyObiektow">
    ...
    <table>
        ...
        <div id="ListaObiektow">
            <form class="FormularzPrzekazywania" action="updareMurali.php" method="get">
                <label for="IdMuralu">Wybierz numer restauracji:</label>
                <select id="IdMuralu" name="IdMuralu" required>
                    <?php foreach ($obiekty as $obiekt): ?>
                        <option value="<?= htmlspecialchars($obiekt['IdMuralu']) ?>"><?= htmlspecialchars($obiekt['IdMuralu']) ?></option>
                    <?php endforeach; ?>
                </select>
                <button class="btn" type="submit">Aktualizuj Mural</button>
            </form>
            <?php foreach ($obiekty as $obiekt): ?>
                <tr>
                    <td>
                    ...
                    <td><?= htmlspecialchars($obiekt['IdMuralu']) ?></td>
                    ...
                    <td><?= htmlspecialchars($obiekt['Opis dotarcia']) ?></td>
                    <td><?= htmlspecialchars($obiekt['Historia']) ?></td>
    ...
    <form action="dodajMural.php" >
        <button class="btn" type="submit" >Dodaj nowy mural</button>
    </form>
</main>
