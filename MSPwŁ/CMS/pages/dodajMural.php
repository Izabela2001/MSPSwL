...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $OpisDotarcia = isset($_POST["OpisDotarcia"]) ? intval($_POST["OpisDotarcia"]) : null;
    $Historia = isset($_POST["Historia"]) ? intval($_POST["Historia"]) : null;
    ...
    $params = array(
        ...
        array(&$OpisDotarcia, SQLSRV_PARAM_IN),
        array(&$Historia, SQLSRV_PARAM_IN),
    ...
    $stmt = sqlsrv_query($conn, "{CALL up_DodajMural(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}", $params);
    if ($stmt === false) {
...
<main id="FromUpdate">
    <form method="post">
        ...
        <div class="right-column">
            ...
            <input type="text" name="OpisDotarcia" placeholder="OpisDotarcia">
            <input type="text" name="Historia" placeholder="Historia">
